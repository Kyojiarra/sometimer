...
final class TimeConversionUtil {
    static String getTimeStringFromMilliseconds(long milliseconds) {
    ...
    static int getHoursFromMilliseconds(long milliseconds) {
        long time = milliseconds / 1000;
        return (int) (time / 3600);
    }

    static int getMinutesFromMilliseconds(long milliseconds) {
        long time = milliseconds / 1000;
        return (int) ((time % 3600) / 60);
    }

    static int getSecondsFromMilliseconds(long milliseconds) {
        long time = milliseconds / 1000;
        return (int) (time % 60);
    }

    static long convertStringToMilliseconds(String time) {
    ...
    static Integer getHoursFromTimeString(String time) {
        if (time.length() > 4) {
    ...
    static Integer getMinutesFromTimeString(String time) {
        if (time.length() > 2) {
            if (time.length() >= 4) {
    ...
    static Integer getSecondsFromTimeString(String time) {
        if (time.length() >= 2) {
